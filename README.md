...
# Problem Overview
The project is focused on predicting future or missing links in a social network using supervised machine learning. Link Prediction is important in many domains such as recommendation systems, bio-informatics or fraud detection. The real-life scenario was simulated by hiding part of the edges in social network to predict them based on node features and graph structure.

# Technologies 
- Programming Language: Python 
- Machine Learning: scikit-learn  
- Data Handling: pandas, NumPy  
- Visualization & Graphs: matplotlib, networkx  
- Utilities: tqdm, datetime
